...
# apply cbind to each element
# generated by lapply()
numerical_summary <-do.call(cbind, lapply(numerical_data, summary))
numerical_summary

# Swap the summary variables as columns
# and the call the variable names as rows
...
proportion_range <- numerical_summary["Max.","Proportion"]-numerical_summary["Min.", "Proportion"]
proportion_range
...
barplot(height = prop.table(table(brexit_data$RegionName)), 
        main = "Vote proportion by the region", 
        ylab = "Frequency",
        xlab = "Region",
        col = "White")
